...
TEXT="Stage: $CI_JOB_STAGE%0AJob: $CI_JOB_NAME%0AStatus: $CI_JOB_STATUS%0A%0AProject:+$MY_CI_PROJECT_NAME%0AURL:+$CI_PROJECT_URL/pipelines/$CI_PIPELINE_ID/%0ABranch:+$CI_COMMIT_REF_SLUG"
